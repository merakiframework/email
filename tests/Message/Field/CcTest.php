...
use Meraki\Email\Message\Field\Cc as CcField;
 ...
 * @covers CcField::
 */
final class CcTest extends FieldTest
{
	/**
	 * @test
	 */
	public function has_correct_name(): void
	{
		...
		$this->assertEquals('Cc', $actualName);
	}
	...
	public function can_get_address_list(): void
	{
		...
		$field = new CcField($expectedAddressList);
	...
	protected function createField(): HeaderField
	{
		...
		return new CcField(new AddressList($mailbox));
	}
}
