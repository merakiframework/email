...
use Meraki\Email\Message\Field\Bcc as BccField;
 ...
 * @covers BccField::
 */
final class BccTest extends FieldTest
{
	/**
	 * @test
	 */
	public function has_correct_name(): void
	{
		...
		$this->assertEquals('Bcc', $actualName);
	}
	...
	public function can_get_address_list_as_body(): void
	{
		...
		$field = new BccField($addressList);
	...
	public function can_get_address_list(): void
	{
		...
		$field = new BccField($expectedAddressList);
	...
	protected function createField(): HeaderField
	{
		...
		return new BccField(new AddressList($mailbox));
	}
}
